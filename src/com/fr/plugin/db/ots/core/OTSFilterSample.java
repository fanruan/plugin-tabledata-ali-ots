...
public class OTSFilterSample {
    ...
    public static void main(String args[]) {
        final String endPoint = "http://fanruan.cn-hangzhou.ots.aliyuncs.com";
        final String accessId = "5BDlOl6BBVH4HdMy";
        final String accessKey = "mulpUXU5FFUmKrUTYMqWoegmCO5MA5";
        final String instanceName = "fanruan";

        OTSClient client = new OTSClient(endPoint, accessId, accessKey, instanceName);
        final String tableName = "xyz";
...
//            }
    ...
    private static void createTable(OTSClient client, String tableName)
        ...
        tableMeta.addPrimaryKeyColumn("card_no", PrimaryKeyType.STRING);
        tableMeta.addPrimaryKeyColumn("card_mo", PrimaryKeyType.STRING);
        // 将该表的读写CU都设置为0
    ...
    private static void generateData(OTSClient client, String tableName)
        ...
        for (int i = 0; i < 100; i++) {
            ...
            primaryKey.addPrimaryKeyColumn("card_no", PrimaryKeyValue.fromString("card" + i));
            primaryKey.addPrimaryKeyColumn("card_mo", PrimaryKeyValue.fromString("card" + i));
